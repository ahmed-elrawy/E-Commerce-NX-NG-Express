...
export class ProductService {
  ...
  insertToCart(productId: number, cartItemId: number, cartQuantity: number): Observable<Product>  | any{
    try {
  ...
  updateProductCartQuantity(productId: number, cartQuantity: number): Observable<void>| any {
    try {
